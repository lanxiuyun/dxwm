...
export const GENERATED_QUESTIONS_BY_SUBJECT = {
  chinese: [
    ...
    },
    {
      ...
      options: ['先洗手，再吃饭。', '吃饭先，再洗手。', '洗手吃饭再，先。', '再先洗手，吃饭。'],
      answer: '先洗手，再吃饭。',
      explanation: '动作先后顺序清楚，语序也自然。',
      level: '初中送分题',
    },
    {
      id: 'g-cn-97',
  ...
  math: [
    ...
    },
    {
      ...
      answer: '120',
      explanation: '1 小时是 60 分钟，2 小时就是 120 分钟。',
      level: '小学送分题',
    },
    {
      id: 'g-ma-19',
    ...
    },
    {
      ...
      subject: '数学',
      type: 'equation',
      prompt: '如果 3x = 21，那么 x 等于多少？',
      options: ['6', '7', '8', '9'],
      answer: '7',
      explanation: '方程两边同时除以 3，得到 x = 7。',
      level: '初中送分题',
    },
    {
      id: 'g-ma-33',
    ...
    },
    {
      ...
      subject: '数学',
      type: 'derivative',
      prompt: '函数 y = x^3 的导函数是？',
      options: ['x^2', '2x', '3x^2', '3x'],
      answer: '3x^2',
      explanation: 'x^3 求导得到 3x^2。',
      level: '大学基础题',
    },
    {
      id: 'g-ma-72',
    ...
    },
    {
      ...
      options: ['2', '3', '5', 'i'],
      answer: '3',
      explanation: '复数 a + bi 中，实部是 a，所以这里实部是 3。',
      level: '大学基础题',
    },
    {
      id: 'g-ma-86',
    ...
    },
    {
      ...
      subject: '数学',
      type: 'sequence',
      prompt: '数列 2，4，6，8，… 更接近哪类数列？',
      options: ['等差数列', '等比数列', '摆动数列', '无规律数列'],
      answer: '等差数列',
      explanation: '相邻两项都相差 2，所以更接近等差数列。',
      level: '高中基础题',
    },
    {
      id: 'g-ma-102',
  ...
  english: [
    ...
    },
    {
      ...
      type: 'academic-expression',
      prompt: 'Which phrase is closer to “总之” ?',
      options: ['in short', 'for example', 'by accident', 'at least'],
      answer: 'in short',
      explanation: 'in short 常用于总结，意思接近“总之、简而言之”。',
      level: '大学基础题',
    },
    {
      id: 'g-en-92',
    ...
    },
    {
      ...
      type: 'academic-expression',
      prompt: 'Which phrase is closer to “例如” ?',
      options: ['for example', 'in short', 'as usual', 'on purpose'],
      answer: 'for example',
      explanation: 'for example 常用来举例说明。',
      level: '大学送分题',
    },
    {
      id: 'g-en-95',
